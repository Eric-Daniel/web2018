...
("Paranormal Activity: The Ghost Dimension",2015,"Horror","paranormalActivityTheGhostDimension.jpg","Using a special camera that can see spirits, a family must protect their daughter from an evil entity with a sinister plan."),
...
("Annihilation",2018,"Adventure, Drama, Fantasy","annihilation.jpg","A biologist signs up for a dangerous, secret expedition into a mysterious zone where the laws of nature don't apply."),
("The Shape of Water",2017,"Fantasy","theShapeOfWater.jpg","At a top secret research facility in the 1960s, a lonely janitor forms a unique relationship with an amphibious creature that is being held in captivity."),
